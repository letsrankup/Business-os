  ...
  return (
    <AppLayout title="Dashboard">
      <div className="flex items-center justify-between">
        ...
        <Link className="px-4 py-2 rounded-xl bg-[#00f5a0] text-black text-sm font-bold hover:bg-[#00f5a0]/80 transition-all" href="/audit">
          + New Audit
        </Link>
      </div>
        ...
        <div className="bg-[#12121a] border border-white/10 rounded-2xl p-5">
          ...
          <div className="space-y-2">
            {quickActions.map((a, i) => (
              <Link className="flex items-center gap-3 p-3 rounded-xl bg-white/5 hover:bg-[#00f5a0]/10 hover:border-[#00f5a0]/30 border border-transparent transition-all group" href="{a.href}" key="{i}">
                <span>{a.icon}</span>
