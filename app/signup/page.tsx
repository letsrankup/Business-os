      ...
      <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-4 font-mono">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-400 text-sm mb-6">
            Tumhare email <span className="text-[#00f5a0]">{form.email}</span> pe
            confirmation link bheja gaya hai. Link click karo aur login karo.
          </p>
          <Link
            href="/login"
    ...
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-4 font-mono">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black text-white">Account Banao</h1>
          <p className="text-gray-400 text-sm mt-1">Free mein shuru karo</p>
        </div>
        ...
        <div className="bg-[#12121a] border border-white/10 rounded-2xl p-6 space-y-4">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            <div>
              <label className="block text-xs text-gray-400 mb-1.5">Poora Naam</label>
              <input
                type="text"
                value={form.fullName}
            ...
            <div>
              <label className="block text-xs text-gray-400 mb-1.5">Password Confirm karo</label>
              <input
                type="password"
